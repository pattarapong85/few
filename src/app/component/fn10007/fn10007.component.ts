...
@Component({
  selector: 'app-fn10007',
  templateUrl: './fn10007.component.html',
  styleUrls: ['./fn10007.component.scss']
})
export class Fn10007Component implements OnInit {
  ...
  this.cols = [
      { field: 'CD', header: 'รหัสหน่วยยูนิต' },
      { field: 'VALUE', header: 'ชื่อหน่วยยูนิต' },
...
save() {
  ...
  if (this.validateBeforeSave(this.newRow)) {
    ...
    this.newRow.SUB_CATEGORY = this.app.PRODUCT.SUB_CATEGORY_UNIT_PRODUCT;
